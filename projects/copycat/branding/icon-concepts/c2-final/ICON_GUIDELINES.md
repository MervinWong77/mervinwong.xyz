...
- `Brand/Icon/CopyCat-BrandMark-Black.svg`
- `Brand/Icon/CopyCat-BrandMark-White.svg`
...
- Tip-to-tip span is tuned so **all four tips stay distinct at 16×16**
...
Keep empty space around the mark of at least **¼ of the mark’s height** on all sides when placing it near wordmarks, other logos, UI chrome, or photography edges.
