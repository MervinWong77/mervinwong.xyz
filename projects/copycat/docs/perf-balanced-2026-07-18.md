...
Fixtures (system temp only — never on user media volumes): SSD `/tmp/copycat-io-bench-ssd` (200×2 MB). Prefer `scripts/make-io-fixture.sh` + `scripts/cleanup-dev-fixtures.sh`.
