      ...
      <div className="mt-6 grid gap-6 md:grid-cols-2 md:gap-8">
        <div className="relative overflow-hidden rounded-2xl border border-stone-200/70 bg-white/70 p-6 shadow-sm ring-1 ring-stone-100/80 backdrop-blur-sm transition hover:shadow-md">
          ...
          <div
            ...
            className="animate-quote-in animate-corner-pixel-float pointer-events-none select-none absolute bottom-5 right-6 h-[165px] w-[165px] opacity-90"
            aria-hidden
          >
            <Image
              ...
              width={165}
              height={165}
              className="h-[165px] w-[165px] select-none drop-shadow-[0_4px_10px_rgba(120,113,108,0.22)] [image-rendering:auto]"
            />
          </div>
        </div>
